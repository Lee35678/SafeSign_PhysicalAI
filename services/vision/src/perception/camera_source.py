...
담당: 이동혁 (vision) · 처음 작성: 송승호 (RPi4B + Camera Module 3 실측, 2026-09-23)

서비스(`perception/capture.py`)와 `scripts/`의 도구들(record_dataset.py, webcam_check.py)이
노트북 웹캠과 RPi5의 Camera Module 3 양쪽에서 그대로 돌아가도록, 카메라를 여는 부분만 여기로
